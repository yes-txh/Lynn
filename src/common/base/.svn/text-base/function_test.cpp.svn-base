...
private:
    DECLARE_UNCOPYABLE(FunctionTest);
};
...
{
    EXPECT_TRUE(base::internal::SupportsAddRefAndRelease<HasRef>::Value);
    EXPECT_FALSE(base::internal::SupportsAddRefAndRelease<NoRef>::Value);
    ...
    // inheritance.
    EXPECT_TRUE(base::internal::SupportsAddRefAndRelease<StrictMock<HasRef> >::Value);
    EXPECT_FALSE(base::internal::SupportsAddRefAndRelease<StrictMock<NoRef> >::Value);
}
