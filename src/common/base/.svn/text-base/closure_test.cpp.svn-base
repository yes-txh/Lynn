...
TEST(Closure, ClassClosure)
{
    ...
    // Closure1
    Closure<short, char>* pRcb0_1 = NewClosure<short, CTest, char>(&obj, &CTest::Rtest0_1);
    short r1 = pRcb0_1->Run('a');
    EXPECT_EQ(980, r1);
    ...
    Closure<int, char, short>* pRcb0_2 =
        NewClosure<int, CTest, char, short>(&obj, &CTest::Rtest0_2);
    int r2 = pRcb0_2->Run('a', 8900);
    EXPECT_EQ(9900, r2);
...
TEST(Closure, ClassPermanentClosure)
{
    ...
    // Closure1
    Closure<short, char>* pRcb0_1 = NewPermanentClosure<short, CTest, char>(&obj, &CTest::Rtest0_1);
    short r1 = pRcb0_1->Run('a');
    EXPECT_EQ(980, r1);
    ...
    // Closure2
    Closure<int, char, short>* pRcb0_2 =
        NewPermanentClosure<int, CTest, char, short>(&obj, &CTest::Rtest0_2);
    int r2 = pRcb0_2->Run('a', 8900);
    EXPECT_EQ(9900, r2);
...
{
    Closure<void>* closure = NewPermanentClosure(&NullFunction);
    for (int i = 0; i < kLoopCount; ++i)
    {
        closure->Run();
    }
