...
//     pump.py invoker_storage.hpp.pump
// DO NOT EDIT BY HAND!!!
...
struct Invoker1<StorageType, R (T::*)(X1, X2, X3, X4, X5)>
{
    ...
    {
        StorageType* invoker = static_cast<StorageType*>(base);
        return (Unwrap(invoker->m_p1)->*invoker->function)(x1, x2, x3, x4, x5);
    }
};
...
public:
    ...
    InvokerStorage0(const Signature& f)
        : function(f)    {
    }
...
public:
    ...
    STATIC_ASSERT(!IsMethod::Value || !TypeTraits::IsArray<P1>::Value,
