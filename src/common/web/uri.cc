        ...
        while (read_pos < uri_string.length())
        {
            ...
            if (':' == ch)
            {
                ...
                break;
                     ...
                     || ('?' == ch) 
                     || ('#' == ch)
                     || (!isalpha((unsigned char)ch) && !isdigit((unsigned char)ch) && ('+' != ch) && ('-' != ch) && ('.' != ch)))
            {
                break;
            }
            read_pos++;
...
bool HttpUri::ParseScheme()
{
    ...
    return (!(m_defined_flag & kDefinedScheme) || (SCHEMES[Scheme::kSchemeHttp].m_scheme_string == m_scheme));
}
...
bool HttpsUri::ParseScheme()
{
    ...
    return (!(m_defined_flag & kDefinedScheme) || (SCHEMES[Scheme::kSchemeHttps].m_scheme_string == m_scheme));
}
...
bool FtpUri::ParseScheme()
{
    ...
    return (!(m_defined_flag & kDefinedScheme) || (SCHEMES[Scheme::kSchemeFtp].m_scheme_string == m_scheme));
}
