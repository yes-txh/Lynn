...
#ifndef COMMON_NET_URI_URI_HPP
#define COMMON_NET_URI_URI_HPP
...
public: // operations
    ...
    static void EscapeString(const char* begin, const char* end, std::string* dest);
    static void EscapeString(const char* begin, size_t length, std::string* dest);
    static void EscapeString(const std::string& src, std::string* dest);
    static void EscapeString(std::string* uri);
