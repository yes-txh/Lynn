...
#include "common/net/poppy/examples/echo_service.pb.h"
...
void protobuf_AssignDesc_common_2fnet_2fpoppy_2fexamples_2fecho_5fservice_2eproto() {
  protobuf_AddDesc_common_2fnet_2fpoppy_2fexamples_2fecho_5fservice_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "common/net/poppy/examples/echo_service.proto");
  GOOGLE_CHECK(file != NULL);
  EchoRequest_descriptor_ = file->message_type(0);
  static const int EchoRequest_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(EchoRequest, user_),
  ...
  static const int EchoResponse_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(EchoResponse, user_),
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_common_2fnet_2fpoppy_2fexamples_2fecho_5fservice_2eproto);
}
...
void protobuf_ShutdownFile_common_2fnet_2fpoppy_2fexamples_2fecho_5fservice_2eproto() {
...
void protobuf_AddDesc_common_2fnet_2fpoppy_2fexamples_2fecho_5fservice_2eproto() {
  static bool already_here = false;
  if (already_here) return;
  already_here = true;
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  ::poppy::protobuf_AddDesc_common_2fnet_2fpoppy_2frpc_5foption_2eproto();
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n,common/net/poppy/examples/echo_service"
    ".proto\022\014rpc_examples\032!common/net/poppy/r"
    "pc_option.proto\",\n\013EchoRequest\022\014\n\004user\030\001"
    " \002(\t\022\017\n\007message\030\002 \002(\t\"-\n\014EchoResponse\022\014\n"
    "\004user\030\001 \002(\t\022\017\n\007message\030\002 \002(\t2\366\001\n\nEchoSer"
    "ver\022C\n\nSimpleEcho\022\031.rpc_examples.EchoReq"
    "uest\032\032.rpc_examples.EchoResponse\022O\n\017Comp"
    "licatedEcho\022\031.rpc_examples.EchoRequest\032\032"
    ".rpc_examples.EchoResponse\"\005\200\342\t\220N\022K\n\013Tim"
    "eoutEcho\022\031.rpc_examples.EchoRequest\032\032.rp"
    "c_examples.EchoResponse\"\005\200\342\t\350\007\032\005\200\342\t\210\'", 437);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "common/net/poppy/examples/echo_service.proto", &protobuf_RegisterTypes);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_common_2fnet_2fpoppy_2fexamples_2fecho_5fservice_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_common_2fnet_2fpoppy_2fexamples_2fecho_5fservice_2eproto {
  StaticDescriptorInitializer_common_2fnet_2fpoppy_2fexamples_2fecho_5fservice_2eproto() {
    protobuf_AddDesc_common_2fnet_2fpoppy_2fexamples_2fecho_5fservice_2eproto();
  }
} static_descriptor_initializer_common_2fnet_2fpoppy_2fexamples_2fecho_5fservice_2eproto_;


// ===================================================================

const ::std::string EchoRequest::_default_user_;
const ::std::string EchoRequest::_default_message_;
#ifndef _MSC_VER
const int EchoRequest::kUserFieldNumber;
...
const EchoRequest& EchoRequest::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_common_2fnet_2fpoppy_2fexamples_2fecho_5fservice_2eproto();  return *default_instance_;
}
...
const ::std::string EchoResponse::_default_user_;
const ::std::string EchoResponse::_default_message_;
#ifndef _MSC_VER
const int EchoResponse::kUserFieldNumber;
...
void EchoServer::SimpleEcho(::google::protobuf::RpcController* controller,
                         const ::rpc_examples::EchoRequest*,
                         ::rpc_examples::EchoResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method SimpleEcho() not implemented.");
  done->Run();
}

void EchoServer::ComplicatedEcho(::google::protobuf::RpcController* controller,
                         const ::rpc_examples::EchoRequest*,
                         ::rpc_examples::EchoResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method ComplicatedEcho() not implemented.");
  done->Run();
}

void EchoServer::TimeoutEcho(::google::protobuf::RpcController* controller,
                         const ::rpc_examples::EchoRequest*,
                         ::rpc_examples::EchoResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method TimeoutEcho() not implemented.");
  done->Run();
}
...
void EchoServer::CallMethod(const ::google::protobuf::MethodDescriptor* method,
  ...
  switch(method->index()) {
    case 0:
      SimpleEcho(controller,
             ::google::protobuf::down_cast<const ::rpc_examples::EchoRequest*>(request),
             ::google::protobuf::down_cast< ::rpc_examples::EchoResponse*>(response),
             done);
      break;
    case 1:
      ComplicatedEcho(controller,
             ::google::protobuf::down_cast<const ::rpc_examples::EchoRequest*>(request),
             ::google::protobuf::down_cast< ::rpc_examples::EchoResponse*>(response),
             done);
      break;
    case 2:
      TimeoutEcho(controller,
             ::google::protobuf::down_cast<const ::rpc_examples::EchoRequest*>(request),
             ::google::protobuf::down_cast< ::rpc_examples::EchoResponse*>(response),
             done);
      break;
...
const ::google::protobuf::Message& EchoServer::GetRequestPrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::rpc_examples::EchoRequest::default_instance();
    case 1:
      return ::rpc_examples::EchoRequest::default_instance();
    case 2:
      return ::rpc_examples::EchoRequest::default_instance();
...
const ::google::protobuf::Message& EchoServer::GetResponsePrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::rpc_examples::EchoResponse::default_instance();
    case 1:
      return ::rpc_examples::EchoResponse::default_instance();
    case 2:
      return ::rpc_examples::EchoResponse::default_instance();
...
void EchoServer_Stub::SimpleEcho(::google::protobuf::RpcController* controller,
...
void EchoServer_Stub::ComplicatedEcho(::google::protobuf::RpcController* controller,
                              const ::rpc_examples::EchoRequest* request,
                              ::rpc_examples::EchoResponse* response,
                              ::google::protobuf::Closure* done) {
...
void EchoServer_Stub::TimeoutEcho(::google::protobuf::RpcController* controller,
                              const ::rpc_examples::EchoRequest* request,
                              ::rpc_examples::EchoResponse* response,
                              ::google::protobuf::Closure* done) {
