...
// source: common/rpc/proto_rpc/examples/echo_service.proto

#ifndef PROTOBUF_common_2frpc_2fproto_5frpc_2fexamples_2fecho_5fservice_2eproto__INCLUDED
#define PROTOBUF_common_2frpc_2fproto_5frpc_2fexamples_2fecho_5fservice_2eproto__INCLUDED
...
void  protobuf_AddDesc_common_2frpc_2fproto_5frpc_2fexamples_2fecho_5fservice_2eproto();
void protobuf_AssignDesc_common_2frpc_2fproto_5frpc_2fexamples_2fecho_5fservice_2eproto();
void protobuf_ShutdownFile_common_2frpc_2fproto_5frpc_2fexamples_2fecho_5fservice_2eproto();
...
class EchoRequest : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_common_2frpc_2fproto_5frpc_2fexamples_2fecho_5fservice_2eproto();
  friend void protobuf_AssignDesc_common_2frpc_2fproto_5frpc_2fexamples_2fecho_5fservice_2eproto();
  friend void protobuf_ShutdownFile_common_2frpc_2fproto_5frpc_2fexamples_2fecho_5fservice_2eproto();
...
class EchoServer_Stub : public EchoServer {
 public:
  ...
  void SimpleEcho(::google::protobuf::RpcController* controller,
                       const ::rpc_examples::EchoRequest* request,
                       ::rpc_examples::EchoResponse* response,
                       ::google::protobuf::Closure* done);
  void ComplicatedEcho(::google::protobuf::RpcController* controller,
                       const ::rpc_examples::EchoRequest* request,
                       ::rpc_examples::EchoResponse* response,
                       ::google::protobuf::Closure* done);
  void TimeoutEcho(::google::protobuf::RpcController* controller,
                       const ::rpc_examples::EchoRequest* request,
                       ::rpc_examples::EchoResponse* response,
                       ::google::protobuf::Closure* done);
 private:
...
class DualEchoServer_Stub;

class DualEchoServer : public ::google::protobuf::Service {
 protected:
  // This class should be treated as an abstract interface.
  inline DualEchoServer() {};
 public:
  virtual ~DualEchoServer();
  
  typedef DualEchoServer_Stub Stub;
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(DualEchoServer);
};

class DualEchoServer_Stub : public DualEchoServer {
 public:
  DualEchoServer_Stub(::google::protobuf::RpcChannel* channel);
  DualEchoServer_Stub(::google::protobuf::RpcChannel* channel,
                   ::google::protobuf::Service::ChannelOwnership ownership);
  ~DualEchoServer_Stub();
  ...
  // implements DualEchoServer ------------------------------------------
  
  void DualEcho(::google::protobuf::RpcController* controller,
                       const ::rpc_examples::EchoRequest* request,
                       ::rpc_examples::EchoResponse* response,
                       ::google::protobuf::Closure* done);
 private:
  ::google::protobuf::RpcChannel* channel_;
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(DualEchoServer_Stub);
};


// -------------------------------------------------------------------

class DualEchoClient_Stub;

class DualEchoClient : public ::google::protobuf::Service {
 protected:
  // This class should be treated as an abstract interface.
  inline DualEchoClient() {};
 public:
  virtual ~DualEchoClient();
  
  typedef DualEchoClient_Stub Stub;
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(DualEchoClient);
};

class DualEchoClient_Stub : public DualEchoClient {
 public:
  DualEchoClient_Stub(::google::protobuf::RpcChannel* channel);
  DualEchoClient_Stub(::google::protobuf::RpcChannel* channel,
                   ::google::protobuf::Service::ChannelOwnership ownership);
  ~DualEchoClient_Stub();
  ...
  // implements DualEchoClient ------------------------------------------
  
  void CollectDualEcho(::google::protobuf::RpcController* controller,
                       const ::rpc_examples::EchoRequest* request,
                       ::rpc_examples::EchoResponse* response,
                       ::google::protobuf::Closure* done);
 private:
  ::google::protobuf::RpcChannel* channel_;
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(DualEchoClient_Stub);
};
...
#endif  // PROTOBUF_common_2frpc_2fproto_5frpc_2fexamples_2fecho_5fservice_2eproto__INCLUDED
