...
#ifndef COMMON_RPC_PROTO_RPC_STREAMING_STREAM_H
#define COMMON_RPC_PROTO_RPC_STREAMING_STREAM_H
...
public:
    ...
    int64_t stream_id() const { return m_stream_id; }
...
#endif // COMMON_RPC_PROTO_RPC_STREAMING_STREAM_H
