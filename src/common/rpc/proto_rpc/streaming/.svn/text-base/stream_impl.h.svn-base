...
#ifndef COMMON_RPC_PROTO_RPC_STREAMING_STREAM_IMPL_H
#define COMMON_RPC_PROTO_RPC_STREAMING_STREAM_IMPL_H

#include "common/base/ref_counted.hpp"
#include "common/rpc/proto_rpc/streaming/packet.h"
...
public:
    ...
    bool Release() {
        {  // for scoped lock.
            ...
            if (GetRefCount() == 2) {
                bool ret = RefCountedBase::Release();
                m_exit_cond.Signal();
                return ret;
            }
        }
...
#endif // COMMON_RPC_PROTO_RPC_STREAMING_STREAM_IMPL_H
