...
#include "common/crypto/rsa2/rsa2_ref/rsa_source/r_random.h"
#include "common/crypto/rsa2/rsa2_ref/rsa_source/nn.h"
#include "common/crypto/rsa2/rsa2_ref/rsa_source/prime.h"
    ...
    static int RelativelyPrime( //a, aDigits, b, bDigits)
        NN_DIGIT* a, unsigned int aDigits,
        NN_DIGIT* b, unsigned int bDigits)
    {
        int status;
