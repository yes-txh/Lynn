#ifndef ATOMIC_MSVC_INTRINSIC_H_INCLUDED
#define ATOMIC_MSVC_INTRINSIC_H_INCLUDED

#include <intrin.h>
#include "common/system/concurrency/atomic/AtomicDefault.h"
#include "common/system/concurrency/atomic/AtomicFunctionForward.h"
    ...
    public AtomicCompareExchangeEmulated<AtomicMscIntrinsic>
{
    ...
    */
    ...
    {
        static bool CompareExchange(volatile long long & target, long long compare, long long exchange, long long & old)
        {
    ...
    // For pointers
    template <typename T>
    static T* CompareExchange(T*& target, T* compare, T* exchange)
    {
        return _InterlockedCompareExchangePointer(value, exchange, compare);
    }

    template <typename T>
    static T* Exchange(T*& target, T* exchange)
    {
...
#endif//ATOMIC_MSVC_INTRINSIC_H_INCLUDED
