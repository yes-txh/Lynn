#ifndef ATOMIC_MSC_X86_ASM_H_INCLUDED
#define ATOMIC_MSC_X86_ASM_H_INCLUDED

#include "common/system/concurrency/atomic/AtomicAsmWidth.h"
...
#endif//ATOMIC_MSC_X86_ASM_H_INCLUDED
