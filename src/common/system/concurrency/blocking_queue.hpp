...
#ifndef COMMON_SYSTEM_CONCURRENCY_BLOCKING_QUEUE_HPP
#define COMMON_SYSTEM_CONCURRENCY_BLOCKING_QUEUE_HPP
...
#endif // COMMON_SYSTEM_CONCURRENCY_BLOCKING_QUEUE_HPP
