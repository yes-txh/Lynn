...
syn keyword bladeTarget cc_library cc_binary cc_test proto_library java_library lex_yacc_library gen_rule
syn keyword bladeArg name srcs deps incs pre_build dynamic_link link_all_symbols extra_cppflags testdata outs cmd
