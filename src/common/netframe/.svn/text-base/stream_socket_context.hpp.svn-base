#ifndef COMMON_NETFRAME_STREAM_SOCKET_CONTEXT_HPP
#define COMMON_NETFRAME_STREAM_SOCKET_CONTEXT_HPP
...
private:
    ...
    /// 当前的包是否以收满
    bool CheckReceivedPacketLength(const char* buffer, size_t size, int& packet_size) const;
...
#endif // COMMON_NETFRAME_STREAM_SOCKET_CONTEXT_HPP
