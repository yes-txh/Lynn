...
class ExecutorIf {
 public:
  ...
  virtual void GetMachineInfo(std::string& _return) = 0;
  virtual bool StartTask(const std::string& task_ad) = 0;
  virtual bool StopTask(const int32_t task_id) = 0;
  virtual bool KillVM(const int32_t task_id) = 0;
};
...
class Executor_GetMachineInfo_args {
 public:

  Executor_GetMachineInfo_args() {
  }

  virtual ~Executor_GetMachineInfo_args() throw() {}


  bool operator == (const Executor_GetMachineInfo_args & /* rhs */) const
  {
    return true;
  }
  bool operator != (const Executor_GetMachineInfo_args &rhs) const {
  ...
  bool operator < (const Executor_GetMachineInfo_args & ) const;
...
class Executor_GetMachineInfo_pargs {
 public:


  virtual ~Executor_GetMachineInfo_pargs() throw() {}
...
typedef struct _Executor_GetMachineInfo_result__isset {
  _Executor_GetMachineInfo_result__isset() : success(false) {}
  bool success;
} _Executor_GetMachineInfo_result__isset;

class Executor_GetMachineInfo_result {
 public:

  Executor_GetMachineInfo_result() : success() {
  }

  virtual ~Executor_GetMachineInfo_result() throw() {}

  std::string success;

  _Executor_GetMachineInfo_result__isset __isset;

  void __set_success(const std::string& val) {
    success = val;
  }

  bool operator == (const Executor_GetMachineInfo_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const Executor_GetMachineInfo_result & ) const;
...
typedef struct _Executor_GetMachineInfo_presult__isset {
  _Executor_GetMachineInfo_presult__isset() : success(false) {}
  bool success;
} _Executor_GetMachineInfo_presult__isset;

class Executor_GetMachineInfo_presult {
 public:


  virtual ~Executor_GetMachineInfo_presult() throw() {}

  std::string* success;

  _Executor_GetMachineInfo_presult__isset __isset;
...
typedef struct _Executor_StopTask_args__isset {
  _Executor_StopTask_args__isset() : task_id(false) {}
  bool task_id;
...
class Executor_StopTask_args {
 public:
  ...
  Executor_StopTask_args() : task_id(0) {
  }
...
typedef struct _Executor_KillVM_args__isset {
  _Executor_KillVM_args__isset() : task_id(false) {}
  bool task_id;
} _Executor_KillVM_args__isset;

class Executor_KillVM_args {
 public:

  Executor_KillVM_args() : task_id(0) {
  }

  virtual ~Executor_KillVM_args() throw() {}

  int32_t task_id;

  _Executor_KillVM_args__isset __isset;

  void __set_task_id(const int32_t val) {
    task_id = val;
  }

  bool operator == (const Executor_KillVM_args & rhs) const
  {
    if (!(task_id == rhs.task_id))
      return false;
    return true;
  ...
  bool operator < (const Executor_KillVM_args & ) const;
...
class Executor_KillVM_pargs {
 public:


  virtual ~Executor_KillVM_pargs() throw() {}
...
typedef struct _Executor_KillVM_result__isset {
  _Executor_KillVM_result__isset() : success(false) {}
  bool success;
} _Executor_KillVM_result__isset;

class Executor_KillVM_result {
 public:

  Executor_KillVM_result() : success(0) {
  }

  virtual ~Executor_KillVM_result() throw() {}

  bool success;

  _Executor_KillVM_result__isset __isset;

  void __set_success(const bool val) {
    success = val;
  }

  bool operator == (const Executor_KillVM_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const Executor_KillVM_result & ) const;
...
typedef struct _Executor_KillVM_presult__isset {
  _Executor_KillVM_presult__isset() : success(false) {}
  bool success;
} _Executor_KillVM_presult__isset;

class Executor_KillVM_presult {
 public:


  virtual ~Executor_KillVM_presult() throw() {}

  bool* success;

  _Executor_KillVM_presult__isset __isset;
...
class ExecutorClient : virtual public ExecutorIf {
 public:
  ...
  void GetMachineInfo(std::string& _return);
  void send_GetMachineInfo();
  void recv_GetMachineInfo(std::string& _return);
  bool StartTask(const std::string& task_ad);
  void send_StartTask(const std::string& task_ad);
  bool recv_StartTask();
  bool StopTask(const int32_t task_id);
  void send_StopTask(const int32_t task_id);
  bool recv_StopTask();
  bool KillVM(const int32_t task_id);
  void send_KillVM(const int32_t task_id);
  bool recv_KillVM();
 protected:
...
class ExecutorProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 private:
  ...
  void process_GetMachineInfo(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  ...
  void process_KillVM(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 public:
  ExecutorProcessor(boost::shared_ptr<ExecutorIf> iface) :
    ...
    processMap_["GetMachineInfo"] = &ExecutorProcessor::process_GetMachineInfo;
    processMap_["StartTask"] = &ExecutorProcessor::process_StartTask;
    processMap_["StopTask"] = &ExecutorProcessor::process_StopTask;
    processMap_["KillVM"] = &ExecutorProcessor::process_KillVM;
  }
...
class ExecutorMultiface : virtual public ExecutorIf {
 ...
 public:
  ...
  void GetMachineInfo(std::string& _return) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->GetMachineInfo(_return);
    }
    ifaces_[i]->GetMachineInfo(_return);
    return;
  }
  ...
  bool StopTask(const int32_t task_id) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->StopTask(task_id);
    }
    return ifaces_[i]->StopTask(task_id);
  }
  ...
  bool KillVM(const int32_t task_id) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->KillVM(task_id);
    }
    return ifaces_[i]->KillVM(task_id);
  }
